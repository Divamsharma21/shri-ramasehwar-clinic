    ...
    const recoveryImages = [
      {
        ...
        description: "Complete recovery from severe jaundice in 3 weeks using natural herbal treatment",
        duration: "3 weeks",
        patientAge: "18 years",
      ...
      },
      {
        id: 2,
        condition: "Anamics",
        beforeImage: "/placeholder.svg?height=300&width=400&text=Before+Kash+Ki+Thali",
        afterImage: "/placeholder.svg?height=300&width=400&text=After+Kash+Ki+Thali",
